...
<div class="wrapper col4">
  <div id="container">
  <div  class="form">
    		<form id="artistconcertaddform" action="<%=request.getContextPath() %>/MusicControl"> 
    			...
    			<p class="contact"><label for="name">Artist ID</label></p> 
    			<input id="name" name="artistid" placeholder="Artist ID"  tabindex="1" type="text">
...
%>
            ...
            <input class="buttom" name="submit" id="submit" tabindex="5" value="Add Concert" type="submit"> 
            <input type="hidden" name="action" value="addnewconcert"></input>
