...
<div class="wrapper col4">
  ...
  PreparedStatement ps3 = connect3.prepareStatement("select * from user where user_id=?;");
  ps3.setString(1, uid);
...
<div id="comments">
        ...
        <%while(rs1.next()){ %>
          <li class="comment_odd">
            <div class="author"><img class="avatar" src="<%=request.getContextPath()%>/Music/profilepic/<%=rs3.getString("image")%>" width="32" height="32" alt="" /><span class="name"><a href="#"><%=rs1.getString("user_id") %></a></span> <span class="wrote">wrote:</span></div>
