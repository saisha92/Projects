...
<div class="wrapper col4">
 ...
 <h2>      <center>CONCERTS </center></h2>
      <table summary="Summary Here" cellpadding="0" cellspacing="0">
	   ...
	   PreparedStatement ps1 = connect1.prepareStatement("select * from concert natural join artist natural join artist_plays where category like '%"+str+"%' or artist_id like '%"+str+"%' or artist_name like '%"+str+"%' or concert_id like '%"+str+"%' and concert_time > now(); ");
