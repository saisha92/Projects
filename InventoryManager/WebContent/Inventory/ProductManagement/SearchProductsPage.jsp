...
Enter Model ID :<font color="red"><sup>*</sup></font>  <input onblur="return checkPass();" type="text" name="id"><SPAN STYLE=color:red ID="ID_error"></SPAN></input><br></br>
<input type='hidden' name='name' value="searchproduct">
