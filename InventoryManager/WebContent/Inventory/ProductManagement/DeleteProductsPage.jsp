...
Productmodel_ID:<font color="red"><sup>*</sup> </font><input type="text" id="id" name="Productmodel_ID" onblur="return checkPass()"></input><SPAN STYLE=color:red ID="ID_error"></SPAN><br></br>
<input type='hidden' name='name' value="deleteproduct">
