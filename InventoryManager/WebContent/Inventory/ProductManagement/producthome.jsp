				...
				<div id="main">
					...
					<div id="content">
						<div id="box1">
							...
							<TABLE>
							<tr>
<td><a href="<%=request.getContextPath() %>/Inventory/ProductManagement/AddProductsPage.jsp">Add Product</a>
</td></tr>
<tr><td>
<a href='<%=request.getContextPath() %>/InventoryController?name=viewproduct'>View Product</a></td></tr>

<tr><td><a href="<%=request.getContextPath() %>/Inventory/ProductManagement/DeleteProductsPage.jsp">Delete Product</a></td></tr>

<tr><td><a href="<%=request.getContextPath() %>/Inventory/ProductManagement/SearchProductsPage.jsp">Update Product</a></td></tr>
