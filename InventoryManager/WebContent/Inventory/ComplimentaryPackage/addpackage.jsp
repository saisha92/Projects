...
function checkid()
{
var strng = document.forms["myForm"]["Packageid"].value;
   if (strng == null||strng=="") {
...
function checkquant()
{
var strng = document.forms["myForm"]["offers"].value;
   if (strng == null||strng=="") {
     
            document.getElementById("offererror").innerHTML = "The offers is not entered";
            return false;
         }
...
<form name="myForm" onsubmit="return validate();" method="post" action="<%=request.getContextPath() %>/InventoryController" name="myForm">
<table align="center"><tr><td>Package Id:<font color="red"><sup>*</sup></font> </td><td><input type="text"  name="Packageid" id="Packageid" onblur="return checkid();" ><SPAN STYLE=color:red ID="iderror"></SPAN></input></td> </tr>
<tr><td>Offers :<font color="red"><sup>*</sup></font> </td><td> <input type="text" name="offers" id="offers" onblur="return checkoffer();"  ><SPAN STYLE=color:red ID="offererror"></SPAN></input></td> </tr>

<input type='hidden' name='name' value="addpackage">
<tr><td> </td>
